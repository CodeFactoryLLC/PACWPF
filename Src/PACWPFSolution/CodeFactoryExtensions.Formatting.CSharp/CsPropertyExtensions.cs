...
namespace CodeFactoryExtensions.Formatting.CSharp
{
    ...
    public static class CsPropertyExtensions
    {
        ...
        public static string CSharpFormatDefaultPropertySignature(this CsProperty source, NamespaceManager manager = null, bool includeKeyword = false,
            ...
            bool requireVirtualKeyword = false, CsSecurity propertySecurity = CsSecurity.Unknown, CsSecurity setSecurity = CsSecurity.Unknown,
            CsSecurity getSecurity = CsSecurity.Unknown)
        {
            if (!source.IsLoaded) return null;
            string propertyDeclaration = CSharpFormatPropertyDeclaration(source, manager,true, includeKeyword, 
                includeAbstractKeyword,requireStaticKeyword,requireSealedKeyword,requireAbstractKeyword,requireOverrideKeyword,
                requireVirtualKeyword, propertySecurity);
            ...
            bool requireVirtualKeyword = false, CsSecurity propertySecurity = CsSecurity.Unknown)
        {
            ...
            if (staticKeyword) propertyBuilder.Append($"{Keywords.Static} ");
            if (sealedKeyword) propertyBuilder.Append($"{Keywords.Sealed} ");
            if (abstractKeyword) propertyBuilder.Append($"{Keywords.Abstract} ");
            if (overrideKeyword) propertyBuilder.Append($"{Keywords.Override} ");
            if (virtualKeyword) propertyBuilder.Append($"{Keywords.Virtual} ");
